...
mysqli_stmt_bind_param($ps,"ssssssssss",$_POST["cpf"],$_POST["nome"],$_POST["endereco"],$_POST["numeroEnd"],$_POST["bairro"],$_POST["cidade"],$_POST["uf"],$_POST["telefone"],$_POST["email"],$_POST["senha"]);
